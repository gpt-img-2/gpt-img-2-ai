...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      description: 'screen AI image and video prompts before generation',
      tab: 'ai',
    },
    {
      name: 'generator',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'creem_moderation_enabled',
      title: 'Creem Prompt Moderation Enabled',
      type: 'switch',
      value: 'false',
      group: 'content_moderation',
      tab: 'ai',
      tip: 'Screen image and video generation prompts with Creem before generation. This is independent from Creem payments.',
    },
    {
      name: 'creem_moderation_fail_closed',
      title: 'Creem Moderation Fail Closed',
      type: 'switch',
      value: 'true',
      group: 'content_moderation',
      tab: 'ai',
      tip: 'When enabled, moderation timeouts or API errors block generation until users retry.',
    },
    {
    ...
    {
      name: 'seedance_2_provider_strategy',
      title: 'Seedance 2.x Provider Strategy',
      type: 'select',
      value: 'kie_with_apimart_face',
      options: [
        {
          title: 'Kie + APIMart Face',
          value: 'kie_with_apimart_face',
        },
        {
          title: 'APIMart All',
      ...
      group: 'seedance',
      tab: 'ai',
      tip: 'Choose Seedance 2.x routing. Face models always use APIMart because Kie does not support them; the default sends non-face Seedance 2.x requests to Kie.',
    },
    {
